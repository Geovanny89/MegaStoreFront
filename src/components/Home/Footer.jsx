    ...
    <button className="bg-blue-600 text-white px-6 py-3 rounded-xl text-sm font-bold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 whitespace-nowrap shadow-lg shadow-blue-100">
      Suscribirme <ArrowRight size={16} className="shrink-0" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          {/* PLATAFORMA */}
          <div>
            <h4 className="font-black text-gray-900 mb-6 text-xs uppercase tracking-[0.2em]">Plataforma</h4>
            <ul className="space-y-4">
              <li>
                <Link to="/tiendas" className="text-gray-500 hover:text-blue-600 text-sm font-medium transition-colors">
                   Directorio de Tiendas
                </Link>
              </li>
              {!token && (
                <li>
                  <Link to="/register-vendedor" className="text-gray-500 hover:text-blue-600 text-sm font-medium transition-colors">
                     Panel de Vendedor
                  </Link>
                </li>
              )}
              <li>
                <Link to="/planes" className="text-gray-500 hover:text-blue-600 text-sm font-medium transition-colors">
                   Planes y Precios
                </Link>
              </li>
            </ul>
