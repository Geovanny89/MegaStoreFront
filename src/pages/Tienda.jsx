        ...
        return (
          <div
            ...
            className={`
              ...
              bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:border-blue-200
            `}
          >
            <div className="flex flex-col items-center p-8 text-center relative">
              ...
              <div className="relative mb-5 mt-2">
                <div className="p-1 bg-white rounded-3xl shadow-md border border-gray-50">
                  <img
              ...
              {/* INFO TIENDA */}
              <h3 className="text-xl font-black text-gray-900 mb-1 hover:text-blue-600 transition-colors line-clamp-1">
                {v.storeName}
              </h3>
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-[1.5rem] font-bold transition-all flex items-center justify-center gap-3 group shadow-lg shadow-blue-100 active:scale-95"
              >
