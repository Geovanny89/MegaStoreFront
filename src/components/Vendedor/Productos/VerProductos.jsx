...
export default function VerProductos() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64 bg-gray-100 dark:bg-gray-900">
  ...
  if (error) {
    return (
      <p className="text-center mt-10 font-bold text-red-600 dark:text-red-400">
        {error}
      </p>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 px-4 pb-10 font-sans text-gray-800 dark:text-gray-100 bg-transparent">
  ...
  ">
      ...
      ">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm font-medium">
                <span className="flex items-center text-blue-600 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider">
                  {producto.brand}
                </span>

                <span className="flex items-center text-gray-500 dark:text-gray-400">
                  <Tag size={14} className="mr-1" /> ${producto.price}
                </span>

                <span
                  className={`flex items-center ${producto.stock < 5
    ...
    "
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-gray-900/70 backdrop-blur-sm flex justify-center items-center p-4">
          <div className="
    ...
    ">
            ...
            <div className="p-8 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
              ...
              <button
                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-500 hover:text-red-500 rounded-full transition-colors"
          ...
          ">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-5">
                  {[
                    ["Colores (coma)", "color", Palette],
                    ["Tallas (coma)", "sise", Layers]
                  ].map(([label, name, Icon]) => (
                    <div key={name}>
                      <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">
                        {label}
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {[...existingImages, ...preview].map((img, i) => (
                      <div
                        key={i}
            ...
            {/* Footer */}
            <div className="p-8 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-3">
              <button
                onClick={() => setModalOpen(false)}
                className="px-8 py-3.5 rounded-2xl font-bold text-gray-500 hover:bg-gray-200 dark:hover:bg-gray-700"
              >
                Cerrar
              </button>
              <button
      ...
      "
          ...
          "
            ...
            font-black
            hover:bg-green-700
            shadow-lg shadow-green-100 dark:shadow-green-900/30
            transition-all active:scale-95
          "
              >
                Aplicar Descuento
