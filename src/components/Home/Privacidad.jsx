    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-16 font-sans text-gray-800 dark:text-slate-200">
        ...
        <header className="mb-12 border-b border-gray-100 dark:border-slate-800 pb-8">
          <h1 className="text-3xl md:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tight uppercase text-left">
            Política de <span className="text-blue-600 dark:text-blue-500">Privacidad</span>
          </h1>
          <p className="text-sm text-gray-500 dark:text-slate-400 font-medium italic text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-12">
          <div className="bg-green-50 dark:bg-green-900/10 p-6 rounded-2xl flex flex-col items-center text-center border border-green-100 dark:border-green-900/20">
            <Lock className="text-green-600 dark:text-green-400 mb-2" size={28} />
            <span className="text-xs font-black uppercase text-green-900 dark:text-green-300">Encriptación SSL</span>
          </div>
          <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl flex flex-col items-center text-center border border-blue-100 dark:border-blue-900/20">
            <EyeOff className="text-blue-600 dark:text-blue-400 mb-2" size={28} />
            <span className="text-xs font-black uppercase text-blue-900 dark:text-blue-300">Uso No Comercial</span>
          </div>
          <div className="bg-purple-50 dark:bg-purple-900/10 p-6 rounded-2xl flex flex-col items-center text-center border border-purple-100 dark:border-purple-900/20">
            <UserCheck className="text-purple-600 dark:text-purple-400 mb-2" size={28} />
            <span className="text-xs font-black uppercase text-purple-900 dark:text-purple-300">Control Total ARCO</span>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 dark:text-white mb-4 uppercase italic text-left">1. Autorización de Tratamiento</h2>
          ...
          <section className="bg-amber-50 dark:bg-amber-900/10 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-amber-100 dark:border-amber-900/20">
            <h2 className="text-xl font-black text-amber-900 dark:text-amber-400 mb-4 uppercase italic flex items-center gap-2 text-left">
              <FileWarning size={24} className="text-amber-600 dark:text-amber-500" /> 2. Datos Sensibles (Biometría y Documentos)
            </h2>
            <p className="text-amber-900 dark:text-amber-200/80 text-sm leading-relaxed text-left">
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 dark:text-white mb-4 uppercase italic text-left">3. Datos que Recolectamos</h2>
            <ul className="list-disc pl-5 space-y-3 text-gray-600 dark:text-slate-400 text-sm text-left">
          ...
          <section className="bg-gray-900 dark:bg-slate-900 text-white p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-slate-800">
            ...
            <p className="text-gray-400 dark:text-slate-300 text-sm leading-relaxed text-left">
              Sus datos se utilizarán para:
            </p>
            <ul className="list-disc pl-5 mt-4 space-y-2 text-gray-400 dark:text-slate-400 text-sm text-left">
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 dark:text-white mb-4 uppercase italic text-left">5. Derechos de los Titulares (Derechos ARCO)</h2>
            <p className="text-gray-600 dark:text-slate-400 leading-relaxed text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mt-6">
              {['Acceso', 'Rectificación', 'Cancelación', 'Oposición'].map((derecho) => (
                <div key={derecho} className="border border-gray-100 dark:border-slate-800 p-3 rounded-xl text-center font-bold text-[10px] md:text-xs text-blue-600 dark:text-blue-400 bg-gray-50 dark:bg-slate-900/50 uppercase">
                  {derecho}
                </div>
              ))}
            </div>
          ...
          <section>
            <h2 className="text-xl font-black text-gray-900 dark:text-white mb-4 uppercase italic text-left">6. Procedimiento de Reclamaciones</h2>
            <p className="text-gray-600 dark:text-slate-400 leading-relaxed text-left">
        ...
        <footer className="mt-20 pt-10 border-t border-gray-100 dark:border-slate-800 text-center">
          <p className="text-gray-400 dark:text-slate-500 text-[10px] uppercase tracking-widest font-bold">
