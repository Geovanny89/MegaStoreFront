      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-16 font-sans text-gray-800">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-12 rounded-r-2xl shadow-sm">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-black text-blue-900 uppercase text-sm mb-1 tracking-wider text-left">Aviso de Naturaleza del Servicio</h3>
        ...
        <div className="space-y-12">
          ...
          <Section icon={<Ban size={20}/>} title="4. Política de Reportes y Bloqueos">
            ...
            <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
              <p className="text-red-900 font-bold mb-3 flex items-center gap-2 text-left">
                <AlertCircle size={18} /> Regla de los 5 Reportes:
              </p>
              <p className="text-red-800 text-sm leading-relaxed mb-4 text-left">
              ...
              <ul className="space-y-3 text-red-800 text-sm font-medium text-left">
                ...
                <li className="flex gap-2">
                  <span>•</span> 
                  <span className="font-black italic underline decoration-red-300">
          ...
          <Section icon={<AlertCircle size={20}/>} title="5. Pagos Directos entre Usuarios">
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              <p className="text-gray-700 font-medium mb-3 text-left">Usted entiende y acepta que:</p>
          ...
          <Section title="6. Limitación de Responsabilidad">
            <p className="text-gray-600 text-sm leading-relaxed border-l-2 border-gray-200 pl-4 text-left">
