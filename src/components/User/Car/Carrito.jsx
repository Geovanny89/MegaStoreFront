...
//   // ⭐ FINALIZAR COMPRA → CREA LA ORDEN
//   const handleCreateOrder = async () => {
//     try {
//       setLoadingOrder(true);
//       const token = localStorage.getItem("token");

//       // Formatear productos al formato que tu backend necesita
//       const productsToSend = carrito.map((item) => ({
//         productId: item.product._id,
//         quantity: item.quantity,
//       }));

//       // Dirección temporal (me dices si ya la tienes guardada)
...
//       // Aquí puedes redirigir a una vista de pago o a checkout
